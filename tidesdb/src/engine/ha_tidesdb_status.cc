...
static void tidesdb_compute_tombstone_stats()
{
    ...
    if (tidesdb_list_column_families(tdb_global, &cf_names, &cf_count) == TDB_SUCCESS && cf_names)
    {
        ...
        {
            if (!cf_names[i] || tidesql_is_reserved_cf(cf_names[i])) continue;
...
static int tdb_show_total_tombstones TDB_SHOW_FUNC_SIG(var, scratch [[maybe_unused]])
{
...
static int tdb_show_tombstone_ratio TDB_SHOW_FUNC_SIG(var, scratch [[maybe_unused]])
{
    tidesdb_compute_tombstone_stats();
...
static int tdb_show_max_sst_density TDB_SHOW_FUNC_SIG(var, scratch [[maybe_unused]])
{
    tidesdb_compute_tombstone_stats();
    var->type = SHOW_DOUBLE;
...
static int tdb_show_max_sst_density_level TDB_SHOW_FUNC_SIG(var, scratch [[maybe_unused]])
{
    tidesdb_compute_tombstone_stats();
    var->type = SHOW_LONGLONG;
...
static TDB_SHOW_VAR_TYPE tidesdb_status_vars_inner[] = {
    TDB_SHOW_VAR_ENTRY("version", &srv_stat_version, SHOW_CHAR_PTR),
    TDB_SHOW_VAR_ENTRY("version_hex", &srv_stat_version_hex, SHOW_LONGLONG),
    TDB_SHOW_VAR_ENTRY("library_version", &srv_stat_library_version, SHOW_CHAR_PTR),
    TDB_SHOW_VAR_ENTRY("column_families", &srv_stat_column_families, SHOW_LONGLONG),
    TDB_SHOW_VAR_ENTRY("global_sequence", &srv_stat_global_seq, SHOW_LONGLONG),
    TDB_SHOW_VAR_ENTRY("memtable_bytes", &srv_stat_memtable_bytes, SHOW_LONGLONG),
    TDB_SHOW_VAR_ENTRY("txn_memory_bytes", &srv_stat_txn_memory_bytes, SHOW_LONGLONG),
    TDB_SHOW_VAR_ENTRY("total_sstables", &srv_stat_total_sstables, SHOW_LONGLONG),
    TDB_SHOW_VAR_ENTRY("open_sstables", &srv_stat_open_sstables, SHOW_LONGLONG),
    TDB_SHOW_VAR_ENTRY("data_size_bytes", &srv_stat_data_size_bytes, SHOW_LONGLONG),
    TDB_SHOW_VAR_ENTRY("immutable_memtables", &srv_stat_immutable_memtables, SHOW_LONGLONG),
    TDB_SHOW_VAR_ENTRY("flush_pending", &srv_stat_flush_pending, SHOW_LONGLONG),
    TDB_SHOW_VAR_ENTRY("compaction_queue", &srv_stat_compaction_queue, SHOW_LONGLONG),
    TDB_SHOW_VAR_ENTRY("cache_entries", &srv_stat_cache_entries, SHOW_LONGLONG),
    TDB_SHOW_VAR_ENTRY("cache_bytes", &srv_stat_cache_bytes, SHOW_LONGLONG),
    TDB_SHOW_VAR_ENTRY("cache_hits", &srv_stat_cache_hits, SHOW_LONGLONG),
    TDB_SHOW_VAR_ENTRY("cache_misses", &srv_stat_cache_misses, SHOW_LONGLONG),
    TDB_SHOW_VAR_ENTRY("cache_hit_rate", &srv_stat_cache_hit_rate, SHOW_DOUBLE),
    TDB_SHOW_VAR_ENTRY("cache_partitions", &srv_stat_cache_partitions, SHOW_LONGLONG),
    TDB_SHOW_FUNC_ENTRY("total_tombstones", &tdb_show_total_tombstones),
    TDB_SHOW_FUNC_ENTRY("tombstone_ratio", &tdb_show_tombstone_ratio),
    TDB_SHOW_FUNC_ENTRY("max_sst_tombstone_density", &tdb_show_max_sst_density),
    TDB_SHOW_FUNC_ENTRY("max_sst_tombstone_density_level", &tdb_show_max_sst_density_level),
    ...
    TDB_SHOW_VAR_ENTRY("compaction_count", &srv_stat_compaction_count, SHOW_LONGLONG),
    TDB_SHOW_VAR_ENTRY("active_transactions", &srv_stat_active_transactions, SHOW_LONGLONG),
    TDB_SHOW_VAR_ENTRY("min_snapshot_sequence", &srv_stat_min_snapshot_seq, SHOW_LONGLONG),
    TDB_SHOW_VAR_ENTRY("vlog_file_size", &srv_stat_vlog_file_size, SHOW_LONGLONG),
    TDB_SHOW_VAR_ENTRY("vlog_value_count", &srv_stat_vlog_value_count, SHOW_LONGLONG),
    TDB_SHOW_VAR_ENTRY("vlog_used_bytes", &srv_stat_vlog_used_bytes, SHOW_LONGLONG),
    TDB_SHOW_VAR_ENTRY("vlog_bytes_written", &srv_stat_vlog_bytes_written, SHOW_LONGLONG),
    ...
    TDB_SHOW_VAR_ENTRY("io_wal_write_bytes", &srv_stat_io_wal_write_bytes, SHOW_LONGLONG),
    TDB_SHOW_VAR_ENTRY("stall_wal_append", &srv_stat_stall_wal_append, SHOW_LONGLONG),
    TDB_SHOW_VAR_ENTRY("stall_rotate_lock", &srv_stat_stall_rotate_lock, SHOW_LONGLONG),
    TDB_SHOW_VAR_ENTRY("stall_rotate_work", &srv_stat_stall_rotate_work, SHOW_LONGLONG),
    TDB_SHOW_VAR_ENTRY("stall_admission", &srv_stat_stall_admission, SHOW_LONGLONG),
...
static int tidesdb_show_status_vars_export TDB_SHOW_FUNC_SIG(var, scratch [[maybe_unused]])
{
...
TDB_SHOW_VAR_TYPE tidesdb_status_variables[] = {
    TDB_SHOW_FUNC_ENTRY("tidesdb", &tidesdb_show_status_vars_export), TDB_SHOW_VAR_END};
